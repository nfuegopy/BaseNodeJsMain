const AreaPersonalService = require('../services/AreaPersonalService');
const AreaPersonal = require('../models/AreaPersonal')
//Controllador para listarPersonales
exports.listarAreas = async (req, res) => {
    try {
        const areapersonales = await AreaPersonalService.listarAreas();
        res.json({ success: true, areapersonales });
    } catch (error) {
